  ...
  return (
    <Stack spacing={3}>
      <Stack alignItems="center" direction="row" spacing={2}>
        <CalculatorIcon color="var(--market-accent, #0B6EFD)" fontSize={32} weight="bold" />
      ...
      <Card sx={{ bgcolor: 'var(--market-surface, #132f4c)' }}>
        <CardContent>
          <Typography color="var(--market-textSecondary, rgba(255,255,255,0.7))">
            Trading calculators for position sizing, risk management, and profit/loss estimation.
          </Typography>
        </CardContent>
      </Card>
    </Stack>
